        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='checi'">
                    <el-form-item class="select" v-if="type!='info'"  label="车票信息" prop="checiId">
                        <el-select v-model="ruleForm.checiId" :disabled="ro.checiId" filterable placeholder="请选择车票信息" @change="checiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='checi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车票类型" prop="checiValue">
                        <el-input v-model="checiForm.checiValue"
                                  placeholder="车票类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   checiId: [
                              { required: true, message: '车票不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
